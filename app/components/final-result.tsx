...
const FinalResult = () => {
  ...
  return (
    <div className="font-[suisse] h-100 flex flex-col justify-center items-center w-3/4 rounded-3xl gap-6">

      <div
        className={cn(
          "h-full flex flex-col bg-neutral-900 text-white justify-center items-center w-full overflow-hidden rounded-3xl p-10 gap-8",
      ...
      >
        ...
        >
          <AnimatedNumber delay={0.5} duration={1} content={Number(averageScore.toFixed(2))}/>
        ...
        <div className="flex flex-col gap-4 w-full items-center">
          ...
          <div className="flex gap-4 flex-wrap justify-center">
            ...
            {scores.map((score, i) => (
              <div
                key={i}
                className="px-4 py-2 rounded-xl bg-neutral-800 text-lg font-medium"
