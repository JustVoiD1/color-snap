...
const Target = () => {
    ...
    return (
        <div ref={scope} className={`relative w-4xl h-full text-black text-center overflow-hidden`}
        // style={{
        ...
        >
            ...
            <div className="absolute inset-0 h-full mx-auto flex justify-center items-center text-4xl font-bold">
                <motion.div className="ready text-white"
                    initial={{
                        opacity: 0,
                        display: "none"
                    }}
                ...
                <motion.div
                    ...
                    className="go text-white opacity-0">Go</motion.div>

            </div>
            {showCounter && <Counter duration={5} className='absolute top-2 right-5 w-fit h-fit mix-blend-difference' />}
        </div>
    )
}
